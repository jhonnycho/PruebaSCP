		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#NorthwindProject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NorthwindProject-display": {
								"semanticObject": "NorthwindProject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.everis.Northwind",
									"url": sap.ui.require.toUrl("com/sap/everis/Northwind")
								}
							}
						}
					}
